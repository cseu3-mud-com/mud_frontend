const roomInfo = () => {
  ...
  const nm14 = ["a few more passages", "a few more rooms and passages", "countless passages", "dozens of similar rooms and passages", "many different passages", "many rooms and passages", "constious different rooms and countless passages", "constious passages"];
  ...
  const nm18 = ["Ash and soot is", "Countless odd symbols are", "Countless runes are", "Dire warning messages are", "Dried blood splatters are", "Intricate carvings are", "Large claw marks are", "Messages in strange languages are", "Ominous symbols are", "Strange writing is", "constious odd symbols are"];
  ...
  const rnd1 = parseInt(Math.floor(Math.random() * nm1.length));
  const rnd2 = parseInt(Math.floor(Math.random() * nm2.length));
  const rnd3 = parseInt(Math.floor(Math.random() * nm3.length));
  const rnd4 = parseInt(Math.floor(Math.random() * nm4.length));
  const rnd5 = parseInt(Math.floor(Math.random() * nm5.length));
  const rnd6 = parseInt(Math.floor(Math.random() * nm6.length));
  const rnd6a = parseInt(Math.floor(Math.random() * nm6.length));
  const rnd6b = parseInt(Math.floor(Math.random() * nm6.length));
  const rnd7 = parseInt(Math.floor(Math.random() * nm7.length));
  const rnd8 = parseInt(Math.floor(Math.random() * nm8.length));
  const rnd9 = parseInt(Math.floor(Math.random() * nm9.length));
  const rnd10 = parseInt(Math.floor(Math.random() * nm10.length));
  const rnd11 = parseInt(Math.floor(Math.random() * nm11.length));
  const rnd12 = parseInt(Math.floor(Math.random() * nm12.length));
  const rnd13 = parseInt(Math.floor(Math.random() * nm13.length));
  const rnd14 = parseInt(Math.floor(Math.random() * nm14.length));
  const rnd15 = parseInt(Math.floor(Math.random() * nm15.length));
  const rnd16 = parseInt(Math.floor(Math.random() * nm16.length));
  const rnd17 = parseInt(Math.floor(Math.random() * nm17.length));
  const rnd18 = parseInt(Math.floor(Math.random() * nm18.length));
  const rnd19 = parseInt(Math.floor(Math.random() * nm19.length));
  const rnd20 = parseInt(Math.floor(Math.random() * nm20.length));
  const rnd21 = parseInt(Math.floor(Math.random() * nm21.length));
  const rnd22 = parseInt(Math.floor(Math.random() * nm22.length));
